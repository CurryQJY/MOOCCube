...
def main():
    ...
    parser.add_argument('--config_files', type=str, default='hyper.yaml', help='fixed config files')
    parser.add_argument('--params_file', type=str, default='hyper', help='parameters file')
    args, _ = parser.parse_known_args()

    # plz set algo='exhaustive' to use exhaustive search, in this case, max_evals is auto set
    config_file_list = args.config_files.strip().split(' ') if args.config_files else None
    hp = HyperTuning(objective_function, algo=tpe.suggest,
