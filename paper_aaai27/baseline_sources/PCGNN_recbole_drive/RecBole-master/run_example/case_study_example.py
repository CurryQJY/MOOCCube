...
if __name__ == '__main__':
    ...
    config = Config(model='test_model', dataset='course', config_dict=config_dict)
    ...
    checkpoint = torch.load('RecBole/saved/test_model-Mar-31-2022_16-39-19.pth')  # Here you can replace it by your model path.
