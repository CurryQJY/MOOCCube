...
class DataBuilder(object):
    """Compatibility stub for the ColdRec base trainer import path.

    The SEMCo cold-start entry points use ColdStartDataBuilder variants. The
    upstream repository imports DataBuilder from this module through
    BaseRecommender, but does not ship the non-cold DataBuilder class.
    """
