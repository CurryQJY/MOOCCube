...
set USIM_OUTPUT_TAG=original_retrieve_no_force_1p200
...
set USIM_LEGACY_EVAL_POS_FROM_BANK=0
set USIM_RESUME=1
set USIM_CHECKPOINT=1
set USIM_STREAM_CKPT=usim_original_retrieve_no_force_1p200.stream_ckpt.pt

(
  echo Started retrieve/no-force 1+200 rerun at %DATE% %TIME%
  ...
  echo.
  echo Finished retrieve/no-force 1+200 rerun at %DATE% %TIME%
  echo ExitCode=%ERRORLEVEL%
) >> "%~dp0usim_original_retrieve_no_force_1p200.out.log" 2>> "%~dp0usim_original_retrieve_no_force_1p200.err.log"
