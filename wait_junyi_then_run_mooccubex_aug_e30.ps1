...
$watchLog = Join-Path $logDir "wait_then_e30.log"
$transcriptLog = Join-Path $logDir "wait_then_e30_transcript.log"
...
Write-Log "Watcher started. Waiting for PID=$WaitPid before launching MOOCCubeX augmented E30 resume."
...
if ($null -ne $proc) {
    ...
    Write-Log "PID $WaitPid is not running. Launching E30 resume immediately."
}

$env:USIM_FB_COURSE_CONCEPT_MIN = "0.01"

Write-Log "Launching MOOCCubeX augmented E30 resume."
...
Write-Log "MOOCCubeX augmented E30 resume finished."
} finally {
