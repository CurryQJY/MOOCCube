...
$outputRoot = "outputs\content_delta_pop5\sage_lite_v1\S11_bucketmlp_tail0p002_e60_seed2025"
$checkpointRoot = "checkpoints\content_delta_pop5\sage_lite_v1\S11_bucketmlp_tail0p002_e60_seed2025"
...
$queueLog = Join-Path $outputRootAbs "mooccube_sage_bucketmlp_tail0p002_queue.log"
...
Write-QueueLog "CONFIG MOOCCube SAGE bucket-MLP tail0p002 seed=2025 | output=$outputRoot | checkpoint=$checkpointRoot | gate_mode=bucket_mlp | buckets=20 | bucket_strategy=paper | gate_hidden=32 | ratio=0.002 | mask=true | scope=all | two_expert=false | epochs=60"
...
Write-QueueLog "START MOOCCube SAGE bucket-MLP tail0p002 seed=2025"
...
Write-QueueLog "END MOOCCube SAGE bucket-MLP tail0p002 seed=2025 | exit_code=$exitCode"
exit $exitCode
