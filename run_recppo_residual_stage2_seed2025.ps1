...
$root = "outputs\recppo_research_repair\recppo_residual_stage2_seed2025"
$ckptRoot = "checkpoints\recppo_research_repair\recppo_residual_stage2_seed2025"
...
$runs=@(
 [pscustomobject]@{Tag="res004_w100";Residual=0.04},
 [pscustomobject]@{Tag="res008_w100";Residual=0.08},
 [pscustomobject]@{Tag="res010_w100";Residual=0.10}
)
...
foreach($r in $runs){
 ...
 & .\run_usim_feedback_fast3_content_delta_static.ps1 `
  ...
  -PseudoColdRatio 0.3 -PseudoColdMinPop 1 -PpoLossWeight 1.0 `
