...
$outputRoot = "outputs\content_delta_pop5\sage_lite_v1\S13_twoexpert_scorefusion_logbucket_tail0p002_e60_seed2025"
$checkpointRoot = "checkpoints\content_delta_pop5\sage_lite_v1\S13_twoexpert_scorefusion_logbucket_tail0p002_e60_seed2025"
...
$queueLog = Join-Path $outputRootAbs "mooccube_sage_twoexpert_scorefusion_logbucket_tail0p002_queue.log"
...
Write-QueueLog "CONFIG MOOCCube SAGE two-expert score-fusion log-bucket tail0p002 seed=2025 | output=$outputRoot | checkpoint=$checkpointRoot | gate_mode=bucket_mlp | buckets=20 | bucket_strategy=log | gate_hidden=32 | ratio=0.002 | mask=true | only_cold_or_tail=false | candidate_two_expert=false | score_fusion=true | epochs=60"
...
Write-QueueLog "START MOOCCube SAGE two-expert score-fusion log-bucket tail0p002 seed=2025"
...
Write-QueueLog "END MOOCCube SAGE two-expert score-fusion log-bucket tail0p002 seed=2025 | exit_code=$exitCode"
exit $exitCode
